"""Feature engineering suggestions route."""
from fastapi import APIRouter, HTTPException, Query
from fastapi.responses import JSONResponse
from routes.upload import DATA_STORE
from services.feature_eng import suggest_features
...
async def get_features(session_id: str, use_cleaned: bool = Query(default=True)):
